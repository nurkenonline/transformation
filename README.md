...
| **ABAI-22** (`ABAI_20260921-175000_INTERNAL_ACTS_ALIGNMENT`) | Гармонизация и синхронизация Положений о подразделениях, ДИ и СОП (13 актов: ДАВ, Регистратор, Департамент науки, Департамент HR, Центр аккредитации/СУР, ДМС, визовый СОП) со стандартами STD-RK-* и функциями доменов | 🟢 Выполнено (Фазы A и B) | `DONE` | Coordinator / Reviewer | [`workspace/ABAI_20260921-175000_INTERNAL_ACTS_ALIGNMENT/review/REVIEW_PHASE_B.md`](file:///g:/Мой%20диск/Google%20AI%20Studio/Abai%20Unviersity%20Transformation/workspace/ABAI_20260921-175000_INTERNAL_ACTS_ALIGNMENT/review/REVIEW_PHASE_B.md) |
| **ABAI-23** (`ABAI_20260922-090000_ACAD_MODELS`) | Нормативная триада моделей среднего академического звена (Факультет, Институт, Школа: типовые положения, ДИ деканов/директора, сквозная параметризация и гармонизация ДАВ, ОР, HR, ЦОС) | 🟢 Выполнено (Фазы A и B) | `DONE` | Coordinator / Reviewer | [`workspace/ABAI_20260922-090000_ACAD_MODELS/review/REVIEW_PHASE_B.md`](file:///g:/Мой%20диск/Google%20AI%20Studio/Abai%20Unviersity%20Transformation/workspace/ABAI_20260922-090000_ACAD_MODELS/review/REVIEW_PHASE_B.md) |
