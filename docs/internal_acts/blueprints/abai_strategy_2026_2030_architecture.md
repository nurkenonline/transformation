...
- Развитие Цифровой платформы [V_SIS_SYSTEM_NAME] и LMS Moodle 5.1 как ядра гибридного образовательного процесса.
...
| **D3.1** | Уровень доступности и отказоустойчивости сервисов платформы [V_SIS_SYSTEM_NAME] (SLA) | 98.2% | 99.5% | **99.9%** | Проректор по цифровизации |
...
1. **Контур «Run the University» (25 сбалансированных KPI):**
   - Утверждается Советом директоров [V_UNIVERSITY_SHORT_NAME] на 5-летний период с годовой декомпозицией;
...
│   • KR 3.2: Обеспечить доступность платформы [V_SIS_SYSTEM_NAME] на уровне SLA 99.9% при     │
...
├────────────────────────────────────────────────────────────────────────────────────────┤
│ OBJECTIVE 4 (O4): Позиционировать [V_UNIVERSITY_SHORT_NAME] как главный научно-образовательный│
