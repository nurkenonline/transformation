...
- Строго соблюдать правила работы с информационными системами (АИС «Цифровая платформа Abai Digital», LMS Moodle, корпоративная электронная почта).
...
6.1. Нарушение положений настоящего Регламента квалифицируется как нарушение трудовой дисциплины и правил безопасности и охраны труда.  
...
1. **Законодательная база РК:** Трудовой кодекс Республики Казахстан (ст. 22, 23, 52, 120, 123, 181, 182), Постановление Правительства РК № 832 (ЕТИКТ и ИБ), Закон РК «О персональных данных и их защите».
...
3. **Контур доказательств и база знаний:** [`workspace/ABAI_20260915-133000_CYBER_TK/evidence/EV__CYBER_TK.md`](file:///g:/Мой%20диск/Google%20AI%20Studio/Abai%20Unviersity%20Transformation/workspace/ABAI_20260915-133000_CYBER_TK/evidence/EV__CYBER_TK.md).
