...
1. **Нормативная база:** Закон РК «Об образовании» (`NPA-001`), Трудовой кодекс РК (ст. 22, 52), КоАП РК (ст. 79), Закон РК «Об информатизации» (`NPA-048`), Спецификация API ЕПВО v3.0.1.
