...
1.1. Настоящий Регламент устанавливает порядок перевода научно-исследовательских работ кафедр, лабораторий и проектных групп НАО «КазНПУ имени Абая» (далее — Университет) с теоретической отчетности на создание практико-ориентированных продуктов — **минимально жизнеспособных продуктов (Minimal Valuable Product — MVP)**.  
...
| Уровень TRL | Стадия зрелости продукта | Что признается подтвержденным результатом в КазНПУ |
|:---:|:---|:---|
