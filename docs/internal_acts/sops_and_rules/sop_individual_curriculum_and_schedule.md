...
## Регуляторный нормативный стандарт [V_UNIVERSITY_SHORT_NAME] (Ликвидация разрыва DEBT-001)

---

### 1. НАЗНАЧЕНИЕ И ОБЛАСТЬ ПРИМЕНЕНИЯ

1.1. Настоящий Регламент устанавливает четкий порядок межуровневого взаимодействия между Офисом регистратора (ОР), деканатами институтов, кафедрами, академическими эдвайзерами и обучающимися [V_UNIVERSITY_SHORT_NAME] (далее — Университет) при планировании и реализации индивидуальных траекторий обучения.  
...
| **Академический эдвайзер** | - Персональное консультирование студентов по выбору элективных дисциплин, миноров и треков.<br>- Проверка соответствия выбранных дисциплин каталогу (КЭД) и образовательной программе.<br>- Подписание электронного листа согласования ИУП в модуле «Эдвайзер» (АД.ТЗ.ADVISER-01) платформы [V_SIS_SYSTEM_NAME]. |
| **Кафедра** | - Предоставление в ОР списка лекторов, ассистентов и языковых отделений дисциплин до начала формирования расписания. |
| **Обучающийся** | - Самостоятельный выбор дисциплин и преподавателей в личном кабинете цифровой платформы [V_SIS_SYSTEM_NAME] в установленные сроки Add/Drop. |
...
sequenceDiagram
    ...
    participant IT as [V_SIS_SYSTEM_NAME]
...
- Офис регистратора загружает дисциплины и требования по пререквизитам в базу данных цифровой платформы [V_SIS_SYSTEM_NAME].
...
- ОР публикует график кампании регистрации (Registration Period) в цифровой платформе [V_SIS_SYSTEM_NAME].
...
4.3. **Категорический запрет ручного добавления обучающихся:**
- Преподавателям строго запрещается допускать к занятиям, принимать задания и вносить в бумажные списки обучающихся, не зарегистрированных в утвержденной цифровой группе модуля «Академический процесс» информационной системы «[V_PRIMARY_EDTECH_PLATFORM]»;
- Оценки и баллы студентов, не прошедших официальную цифровую регистрацию в ИУП через УИС, признаются недействительными и аннулируются;
- Факт допуска незарегистрированного студента к занятиям расценивается как нарушение трудовой дисциплины преподавателем в соответствии со ст. 22 Трудового кодекса РК.

---

### 5. ЦИФРОВОЙ КОНТУР И ОТВЕТСТВЕННОСТЬ В УИС («[V_PRIMARY_EDTECH_PLATFORM]»)

5.1. Весь процесс выборной кампании Add/Drop и согласования ИУП проходит исключительно в безбумажном виде в модуле «Эдвайзер» (`АД.ТЗ.ADVISER-01`) и личном кабинете студента.  
5.2. Срок электронного согласования ИУП эдвайзером — **не более 3 (трех) рабочих дней** с момента подачи заявки обучающимся.  
5.3. Срыв сроков согласования ИУП эдвайзером влечет дисциплинарное взыскание по представлению Руководителя Офиса регистратора.  
5.4. Любые изменения в утвержденный ИУП после закрытия периода Late Add/Drop вносятся исключительно по приказу [V_CHANCELLOR_TITLE] с фиксацией в журнале транзакций БД (Audit Trail).

---

### 6. МАТРИЦА RACI РЕГЛАМЕНТА ИУП
