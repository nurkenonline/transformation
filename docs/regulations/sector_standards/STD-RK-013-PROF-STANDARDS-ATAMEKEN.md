...
- **Базовая часть (Юридический инвариант):** общие положения, иерархия подчинения, трудовые права и обязанности по ст. 22, 23 ТК РК, персональная дисциплинарная, материальная (ст. 120, 123 ТК) и административная ответственность (ст. 79, 93, 98 КоАП РК);
