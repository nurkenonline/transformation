...
1. **Управление цифровизации (Software Engineering & Architecture):** Архитектурное проектирование, разработка и кастомизация 22 прикладных модулей УИС («[V_SIS_SYSTEM_NAME]» / УИС SIS), интеграционные шлюзы с государственными системами (Buffer-Mirror Sync с ЕПВО/НОБД по 5 протоколам МНВО РК, Smart Bridge).
